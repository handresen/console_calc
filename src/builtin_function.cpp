...
constexpr std::array<BuiltinFunctionInfo, 48> k_builtin_functions = {{
    ...
    {Function::rotate_path, "rotate_path", 3, 3, BuiltinFunctionCategory::position, false, false, "rotate_path(poslist|multi_pos_list, center_index, degrees)", "rotate path list(s) around a chosen point index using center-relative geodesic bearings"},
